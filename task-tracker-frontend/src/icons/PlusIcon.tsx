...
const PlusIcon: React.FC<PlusIconProps> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      ...
      <path d="M332.44,237.14h-57.7v-57.7c0-24.4-37.92-24.44-37.92,0v57.7H179.13c-24.4,0-24.44,37.92,0,37.92h57.69v57.69c0,24.4,37.92,24.44,37.92,0V275.06h57.7C356.84,275.06,356.88,237.14,332.44,237.14Z" />
    </svg>
  );
};
